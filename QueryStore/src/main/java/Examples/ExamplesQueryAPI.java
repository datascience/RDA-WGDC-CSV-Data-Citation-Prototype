...
public class ExamplesQueryAPI {
    ...
    public void createNewQuery(){
       ...
       // create test identifiers
        PersistentIdentifierAlphaNumeric pid =  pidAPI.getAlphaNumericPID(researchOrganization , "www.repository,org/queries/q1");
        ...
        // Create a query
        Query query = queryAPI.createNewQuery("username@repository.org","Descriptive query text",dataSourcePID, queryPID);
        ...
        // create identifiers
        PersistentIdentifierAlphaNumeric newPid = pidAPI.getAlphaNumericPID(researchOrganization, "www.evlil.org/query");
        String newQueryPID = pidAPI.getIdentifierStringWithPrefix(newPid);
        // second query
        Query newQuery= queryAPI.createNewQuery("username@repository.org","Different query text",dataSourcePID, newQueryPID);
